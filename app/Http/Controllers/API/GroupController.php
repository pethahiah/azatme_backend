...
//     // Fetch group-related user transactions
//     $getUserGroupAddedTransactions = userGroup::where('email', $getAuthUser->email)
//         ->whereNull('deleted_at')
//         ->whereNull('merchantReference')
//         ->orderBy('created_at', 'desc')
//         ->paginate($perPage, ['*'], 'page', $page);

//     // Get expense IDs for groups created by the authenticated user
//     $groupIds = DB::table('expenses')
//         ->join('user_groups', function ($join) {
//             $join->on('expenses.user_id', '=', 'user_groups.reference_id')
//                  ->on('expenses.id', '=', 'user_groups.group_id');
...
//     // Fetch group expenses with aggregation
//     $getUserGroupExpense = DB::table('expenses')
//         ->join('user_groups', function ($join) {
//             $join->on('expenses.user_id', '=', 'user_groups.reference_id')
//                  ->on('expenses.id', '=', 'user_groups.group_id');
...
//             'expenses.updated_at',
//             'expenses.confirm',
//             DB::raw('SUM(user_groups.residualAmount) as total_paid')
//         )
//         ->whereIn('expenses.id', $groupIds)
//         ->whereNull('user_groups.merchantReference')
//         ->whereNull('expenses.deleted_at')
