...
public function createReferral(Request $request, $requestData)
{
    ...
    return ReferralSetting::create([
        ...
        'referral_active_point' => $requestData['referral_active_point'] ?? null,
        'product_getting_point' => $requestData['product_getting_point'] ?? null,
	  'amount_conversion' => $requestData['amount_conversion'] ?? null,
    ]);
}
