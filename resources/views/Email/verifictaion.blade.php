...
<html>
  ...
  <body class="">
    <span class="preheader">Withrawal EMail Verification</span>
                    ...
                    <tr>
                      <td>
                       ...
                       <p
                                            ...
                                            We've received a request to verify your withdrawal Email.
                                            </p>
                                        <p
                                            style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                          Kindly find your withdrawal verification token 
                                        </p> <strong>{{$otp}}</strong></p>
                                        
                                                                                <p
                                            style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                          Please note that withdrawal verification token expires in <strong>15 mins</strong>
